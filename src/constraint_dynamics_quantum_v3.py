...
def make_current_goal_completion_audit_outputs(
    ...
    g11_closure_evidence_arxiv_package_acceptance_manifest_rows = int(
        _first_value(
            public_g11_exhaustion,
            "closure_evidence_arxiv_package_acceptance_manifest_rows",
            0,
        )
    )
    g11_closure_evidence_arxiv_package_acceptance_manifest_status = str(
        _first_value(
            public_g11_exhaustion,
            "closure_evidence_arxiv_package_acceptance_manifest_status",
            "not available",
        )
    )
    g11_closure_evidence_top_arxiv_package_acceptance_candidate_id = str(
        _first_value(
            public_g11_exhaustion,
            "closure_evidence_top_arxiv_package_acceptance_candidate_id",
            "not available",
        )
    )
    g11_closure_evidence_top_arxiv_package_required_artifact = str(
        _first_value(
            public_g11_exhaustion,
    ...
    g11_closure_evidence_arxiv_package_retrieval_ledger_rows = int(
        _first_value(
            public_g11_exhaustion,
            "closure_evidence_arxiv_package_retrieval_ledger_rows",
            0,
        )
    )
    g11_closure_evidence_arxiv_package_retrieval_status = str(
        _first_value(
            public_g11_exhaustion,
    ...
    g11_closure_evidence_top_arxiv_package_retrieval_candidate_id = str(
        _first_value(
            public_g11_exhaustion,
    ...
    g11_closure_evidence_top_arxiv_package_expected_archive = str(
        _first_value(
            public_g11_exhaustion,
    ...
    g11_closure_evidence_arxiv_package_inspection_checklist_rows = int(
        _first_value(
            public_g11_exhaustion,
            "closure_evidence_arxiv_package_inspection_checklist_rows",
            0,
        )
    )
    g11_closure_evidence_arxiv_package_inspection_status = str(
        _first_value(
            public_g11_exhaustion,
            "closure_evidence_arxiv_package_inspection_status",
            "not available",
        )
    )
    g11_closure_evidence_top_arxiv_package_inspection_candidate_id = str(
        _first_value(
            public_g11_exhaustion,
            "closure_evidence_top_arxiv_package_inspection_candidate_id",
            "not available",
        )
    )
    g11_closure_evidence_top_arxiv_package_inspection_pattern = str(
        _first_value(
            public_g11_exhaustion,
            "closure_evidence_top_arxiv_package_inspection_pattern",
            "not available",
        )
    )
    g11_closure_evidence_arxiv_package_local_inspection_rows = int(
        _first_value(
            public_g11_exhaustion,
            "closure_evidence_arxiv_package_local_inspection_rows",
            0,
        )
    )
    g11_closure_evidence_arxiv_package_local_inspection_status = str(
        _first_value(
            public_g11_exhaustion,
            "closure_evidence_arxiv_package_local_inspection_status",
            "not available",
        )
    )
    g11_closure_evidence_top_arxiv_package_local_inspection_candidate_id = str(
        _first_value(
            public_g11_exhaustion,
            "closure_evidence_top_arxiv_package_local_inspection_candidate_id",
            "not available",
        )
    )
    g11_closure_evidence_top_arxiv_package_local_inspection_match_count = int(
        _first_value(
            public_g11_exhaustion,
    ...
    g11_closure_evidence_arxiv_package_cache_alias_rows = int(
        _first_value(
            public_g11_exhaustion,
            "closure_evidence_arxiv_package_cache_alias_rows",
            0,
        )
    )
    g11_closure_evidence_arxiv_package_cache_alias_status = str(
        _first_value(
            public_g11_exhaustion,
    ...
    g11_closure_evidence_top_arxiv_package_cache_alias_candidate_id = str(
        _first_value(
            public_g11_exhaustion,
    ...
    g11_closure_evidence_top_arxiv_package_cache_alias_legacy_dir = str(
        _first_value(
            public_g11_exhaustion,
    ...
    g11_closure_evidence_arxiv_package_cache_probe_plan_rows = int(
        _first_value(
            public_g11_exhaustion,
            "closure_evidence_arxiv_package_cache_probe_plan_rows",
            0,
        )
    )
    g11_closure_evidence_arxiv_package_cache_probe_plan_status = str(
        _first_value(
            public_g11_exhaustion,
    ...
    g11_closure_evidence_top_arxiv_package_cache_probe_candidate_id = str(
        _first_value(
            public_g11_exhaustion,
    ...
    g11_closure_evidence_top_arxiv_package_cache_probe_expected_min_files = int(
        _first_value(
            public_g11_exhaustion,
    ...
    rows = [
        ...
        },
        {
            ...
            "note": (
                ...
                f"closure_arxiv_package_acceptance_manifest={g11_closure_evidence_arxiv_package_acceptance_manifest_rows}; "
                f"closure_arxiv_package_acceptance_status={g11_closure_evidence_arxiv_package_acceptance_manifest_status}; "
                f"closure_top_arxiv_package_acceptance_candidate={g11_closure_evidence_top_arxiv_package_acceptance_candidate_id}; "
                f"closure_top_arxiv_package_required_artifact={g11_closure_evidence_top_arxiv_package_required_artifact}; "
                f"closure_arxiv_package_retrieval_ledger={g11_closure_evidence_arxiv_package_retrieval_ledger_rows}; "
                f"closure_arxiv_package_retrieval_status={g11_closure_evidence_arxiv_package_retrieval_status}; "
                f"closure_top_arxiv_package_retrieval_candidate={g11_closure_evidence_top_arxiv_package_retrieval_candidate_id}; "
                f"closure_top_arxiv_package_expected_archive={g11_closure_evidence_top_arxiv_package_expected_archive}; "
                f"closure_arxiv_package_inspection_checklist={g11_closure_evidence_arxiv_package_inspection_checklist_rows}; "
                f"closure_arxiv_package_inspection_status={g11_closure_evidence_arxiv_package_inspection_status}; "
                f"closure_top_arxiv_package_inspection_candidate={g11_closure_evidence_top_arxiv_package_inspection_candidate_id}; "
                f"closure_top_arxiv_package_inspection_pattern={g11_closure_evidence_top_arxiv_package_inspection_pattern}; "
                f"closure_arxiv_package_local_inspection_rows={g11_closure_evidence_arxiv_package_local_inspection_rows}; "
                f"closure_arxiv_package_local_inspection_status={g11_closure_evidence_arxiv_package_local_inspection_status}; "
                f"closure_top_arxiv_package_local_inspection_candidate={g11_closure_evidence_top_arxiv_package_local_inspection_candidate_id}; "
                f"closure_top_arxiv_package_local_inspection_match_count={g11_closure_evidence_top_arxiv_package_local_inspection_match_count}; "
                f"closure_arxiv_package_cache_alias_rows={g11_closure_evidence_arxiv_package_cache_alias_rows}; "
                f"closure_arxiv_package_cache_alias_status={g11_closure_evidence_arxiv_package_cache_alias_status}; "
                f"closure_top_arxiv_package_cache_alias_candidate={g11_closure_evidence_top_arxiv_package_cache_alias_candidate_id}; "
                f"closure_top_arxiv_package_cache_alias_legacy_dir={g11_closure_evidence_top_arxiv_package_cache_alias_legacy_dir}; "
                f"closure_arxiv_package_cache_probe_plan_rows={g11_closure_evidence_arxiv_package_cache_probe_plan_rows}; "
                f"closure_arxiv_package_cache_probe_plan_status={g11_closure_evidence_arxiv_package_cache_probe_plan_status}; "
                f"closure_top_arxiv_package_cache_probe_candidate={g11_closure_evidence_top_arxiv_package_cache_probe_candidate_id}; "
                f"closure_top_arxiv_package_cache_probe_expected_min_files={g11_closure_evidence_top_arxiv_package_cache_probe_expected_min_files}; "
        ...
        [
            {
                ...
                "g11_closure_evidence_arxiv_package_acceptance_manifest_rows": g11_closure_evidence_arxiv_package_acceptance_manifest_rows,
                "g11_closure_evidence_arxiv_package_acceptance_manifest_status": g11_closure_evidence_arxiv_package_acceptance_manifest_status,
                "g11_closure_evidence_top_arxiv_package_acceptance_candidate_id": g11_closure_evidence_top_arxiv_package_acceptance_candidate_id,
                "g11_closure_evidence_top_arxiv_package_required_artifact": g11_closure_evidence_top_arxiv_package_required_artifact,
                "g11_closure_evidence_arxiv_package_retrieval_ledger_rows": g11_closure_evidence_arxiv_package_retrieval_ledger_rows,
                "g11_closure_evidence_arxiv_package_retrieval_status": g11_closure_evidence_arxiv_package_retrieval_status,
                "g11_closure_evidence_top_arxiv_package_retrieval_candidate_id": g11_closure_evidence_top_arxiv_package_retrieval_candidate_id,
                "g11_closure_evidence_top_arxiv_package_expected_archive": g11_closure_evidence_top_arxiv_package_expected_archive,
                "g11_closure_evidence_arxiv_package_inspection_checklist_rows": g11_closure_evidence_arxiv_package_inspection_checklist_rows,
                "g11_closure_evidence_arxiv_package_inspection_status": g11_closure_evidence_arxiv_package_inspection_status,
                "g11_closure_evidence_top_arxiv_package_inspection_candidate_id": g11_closure_evidence_top_arxiv_package_inspection_candidate_id,
                "g11_closure_evidence_top_arxiv_package_inspection_pattern": g11_closure_evidence_top_arxiv_package_inspection_pattern,
                "g11_closure_evidence_arxiv_package_local_inspection_rows": g11_closure_evidence_arxiv_package_local_inspection_rows,
                "g11_closure_evidence_arxiv_package_local_inspection_status": g11_closure_evidence_arxiv_package_local_inspection_status,
                "g11_closure_evidence_top_arxiv_package_local_inspection_candidate_id": g11_closure_evidence_top_arxiv_package_local_inspection_candidate_id,
                "g11_closure_evidence_top_arxiv_package_local_inspection_match_count": g11_closure_evidence_top_arxiv_package_local_inspection_match_count,
                "g11_closure_evidence_arxiv_package_cache_alias_rows": g11_closure_evidence_arxiv_package_cache_alias_rows,
                "g11_closure_evidence_arxiv_package_cache_alias_status": g11_closure_evidence_arxiv_package_cache_alias_status,
                "g11_closure_evidence_top_arxiv_package_cache_alias_candidate_id": g11_closure_evidence_top_arxiv_package_cache_alias_candidate_id,
                "g11_closure_evidence_top_arxiv_package_cache_alias_legacy_dir": g11_closure_evidence_top_arxiv_package_cache_alias_legacy_dir,
                "g11_closure_evidence_arxiv_package_cache_probe_plan_rows": g11_closure_evidence_arxiv_package_cache_probe_plan_rows,
                "g11_closure_evidence_arxiv_package_cache_probe_plan_status": g11_closure_evidence_arxiv_package_cache_probe_plan_status,
                "g11_closure_evidence_top_arxiv_package_cache_probe_candidate_id": g11_closure_evidence_top_arxiv_package_cache_probe_candidate_id,
                "g11_closure_evidence_top_arxiv_package_cache_probe_expected_min_files": g11_closure_evidence_top_arxiv_package_cache_probe_expected_min_files,
...
- G11 closure evidence arXiv package acceptance manifest rows: {g11_closure_evidence_arxiv_package_acceptance_manifest_rows}
- G11 closure evidence arXiv package acceptance manifest status: {g11_closure_evidence_arxiv_package_acceptance_manifest_status}
- G11 closure evidence top arXiv package required artifact: {g11_closure_evidence_top_arxiv_package_required_artifact}
- G11 closure evidence arXiv package retrieval ledger rows: {g11_closure_evidence_arxiv_package_retrieval_ledger_rows}
- G11 closure evidence arXiv package retrieval status: {g11_closure_evidence_arxiv_package_retrieval_status}
- G11 closure evidence top arXiv package expected archive: {g11_closure_evidence_top_arxiv_package_expected_archive}
- G11 closure evidence arXiv package inspection checklist rows: {g11_closure_evidence_arxiv_package_inspection_checklist_rows}
- G11 closure evidence arXiv package inspection status: {g11_closure_evidence_arxiv_package_inspection_status}
- G11 closure evidence top arXiv package inspection pattern: {g11_closure_evidence_top_arxiv_package_inspection_pattern}
- G11 closure evidence arXiv package local inspection rows: {g11_closure_evidence_arxiv_package_local_inspection_rows}
- G11 closure evidence arXiv package local inspection status: {g11_closure_evidence_arxiv_package_local_inspection_status}
- G11 closure evidence top arXiv package local inspection matches: {g11_closure_evidence_top_arxiv_package_local_inspection_match_count}
- G11 closure evidence arXiv package cache alias rows: {g11_closure_evidence_arxiv_package_cache_alias_rows}
- G11 closure evidence arXiv package cache alias status: {g11_closure_evidence_arxiv_package_cache_alias_status}
- G11 closure evidence top arXiv package cache alias legacy dir: {g11_closure_evidence_top_arxiv_package_cache_alias_legacy_dir}
- G11 closure evidence arXiv package cache probe plan rows: {g11_closure_evidence_arxiv_package_cache_probe_plan_rows}
- G11 closure evidence arXiv package cache probe plan status: {g11_closure_evidence_arxiv_package_cache_probe_plan_status}
- G11 closure evidence top arXiv package cache probe expected min files: {g11_closure_evidence_top_arxiv_package_cache_probe_expected_min_files}
...
def make_public_g11_exhaustion_audit_outputs(
    ...
    package_acceptance_rows = []
    intake_by_candidate = (
        evidence_intake.set_index("candidate_id")
        if not evidence_intake.empty and "candidate_id" in evidence_intake.columns
        else pd.DataFrame()
    )
    for _, row in source_package_inventory.iterrows():
        candidate_id = str(row["candidate_id"])
        intake_row = (
            intake_by_candidate.loc[candidate_id]
            if candidate_id in intake_by_candidate.index
            else {}
        )
        if isinstance(intake_row, pd.DataFrame):
            intake_row = intake_row.iloc[0]
        required_columns = str(
            intake_row.get("minimum_columns", "not available")
            if hasattr(intake_row, "get")
            else "not available"
        )
        required_artifacts = [
            artifact.strip()
            for artifact in str(row["artifact_focuses"]).split(";")
            if artifact.strip()
        ]
        for artifact in required_artifacts:
            package_acceptance_rows.append(
                {
                    ...
                    "package_acceptance_status": "not_checked",
                    "triage_question": (
                        "Does the extracted arXiv source package contain "
                        f"{artifact} or an explicit absence note for it?"
                    ),
                    "acceptance_gate": row["acceptance_gate"],
                    "closure_boundary": row["overclaim_boundary"],
                }
            )
    package_acceptance_manifest = pd.DataFrame(
        package_acceptance_rows,
        columns=[
            "package_rank",
            "candidate_id",
            ...
            "required_artifact",
            "required_columns",
            "package_acceptance_status",
            "triage_question",
            "acceptance_gate",
            "closure_boundary",
        ],
    )
    package_acceptance_manifest.to_csv(
        output_dir
        / "public_g11_closure_evidence_arxiv_source_package_acceptance_manifest.csv",
        index=False,
    )
    package_retrieval_rows = []
    for _, row in source_package_inventory.iterrows():
        candidate_id = str(row["candidate_id"])
        expected_dir = f"outputs/tmp/arxiv_source_packages/{candidate_id}"
        expected_archive = f"{expected_dir}/source.tar"
        package_retrieval_rows.append(
            {
                "package_rank": int(row["package_rank"]),
                "candidate_id": candidate_id,
                "study": row["study"],
                ...
                "expected_extract_dir": f"{expected_dir}/extracted",
                "retrieval_status": "not_fetched",
                "sha256_status": "pending_fetch",
                "retrieval_command": (
                    f"mkdir -p {expected_dir} && "
                    f"curl -L {row['source_eprint_url']} -o {expected_archive}"
                ),
                "post_fetch_inventory_command": (
                    f"mkdir -p {expected_dir}/extracted && "
                    f"tar -xf {expected_archive} -C {expected_dir}/extracted && "
                    f"(sha256sum {expected_archive} || shasum -a 256 {expected_archive}) && "
                    f"find {expected_dir}/extracted -maxdepth 2 -type f | sort"
                ),
                "acceptance_manifest_path": (
                    "outputs/public_g11_exhaustion/"
                    "public_g11_closure_evidence_arxiv_source_package_acceptance_manifest.csv"
                ),
                "overclaim_boundary": row["overclaim_boundary"],
            }
        )
    package_retrieval_ledger = pd.DataFrame(
        package_retrieval_rows,
        columns=[
            "package_rank",
            "candidate_id",
    ...
    package_retrieval_ledger.to_csv(
        output_dir
        / "public_g11_closure_evidence_arxiv_source_package_retrieval_ledger.csv",
        index=False,
    )
    search_pattern_by_artifact = {
        "beam_deflection_broadening_calibration.csv": (
            "beam|deflection|broadening|calibration|kappa"
        ),
        "kappa_uncertainty_notes.md": "kappa|uncertainty|standard error|se|sigma",
        "paired_contrast_values.csv": "contrast|visibility|decoherence|kappa",
        "record_distribution.csv": "record|momentum|distribution|weak|shift",
        "setting_pairing_notes.md": "setting|pair|which-way|visibility|contrast",
        "visibility_or_contrast_sweep.csv": (
            "visibility|contrast|fringe|which-way|weak"
        ),
        "independence_provenance.md": (
            "independent|provenance|measured|fit|visibility"
        ),
        "independent_record_distribution.csv": (
            "record|distribution|momentum|correlation|width"
        ),
        "paired_visibility_or_contrast.csv": (
            "visibility|contrast|fringe|coherence|setting"
        ),
    }
    retrieval_by_candidate = (
        package_retrieval_ledger.set_index("candidate_id")
        if not package_retrieval_ledger.empty
        and "candidate_id" in package_retrieval_ledger.columns
        else pd.DataFrame()
    )
    package_inspection_rows = []
    for _, row in package_acceptance_manifest.iterrows():
        candidate_id = str(row["candidate_id"])
        retrieval_row = (
            retrieval_by_candidate.loc[candidate_id]
            if candidate_id in retrieval_by_candidate.index
            else {}
        )
        if isinstance(retrieval_row, pd.DataFrame):
            retrieval_row = retrieval_row.iloc[0]
        expected_extract_dir = str(
            retrieval_row.get("expected_extract_dir", "not available")
            if hasattr(retrieval_row, "get")
            else "not available"
        )
        required_artifact = str(row["required_artifact"])
        pattern = search_pattern_by_artifact.get(
            required_artifact,
            required_artifact.replace("_", "|").replace(".csv", "").replace(".md", ""),
        )
        package_inspection_rows.append(
            {
                "package_rank": int(row["package_rank"]),
                "candidate_id": candidate_id,
                "study": row["study"],
                "required_artifact": required_artifact,
                "expected_extract_dir": expected_extract_dir,
                "artifact_search_pattern": pattern,
                "inspection_status": "pending_fetch",
                "inspection_command": (
                    f"test -d {expected_extract_dir} && "
                    f"find {expected_extract_dir} -maxdepth 3 -type f | sort && "
                    f"grep -RIlE '{pattern}' {expected_extract_dir} || true"
                ),
                "required_columns": row["required_columns"],
                "closure_boundary": row["closure_boundary"],
            }
        )
    package_inspection_checklist = pd.DataFrame(
        package_inspection_rows,
        columns=[
            "package_rank",
            "candidate_id",
    ...
    package_inspection_checklist.to_csv(
        output_dir
        / "public_g11_closure_evidence_arxiv_source_package_inspection_checklist.csv",
        index=False,
    )
    package_local_inspection_rows = []
    for _, row in package_inspection_checklist.iterrows():
        expected_extract_dir = Path(str(row["expected_extract_dir"]))
        pattern_text = str(row["artifact_search_pattern"])
        matched_files = []
        if expected_extract_dir.is_dir():
            pattern = re.compile(pattern_text, re.IGNORECASE)
            for path in sorted(expected_extract_dir.rglob("*")):
                if not path.is_file():
                    continue
                relative_path = path.relative_to(expected_extract_dir).as_posix()
                matched = bool(pattern.search(relative_path))
                if not matched:
                    try:
            ...
            local_status = "pattern_matches_found" if matched_files else "no_pattern_matches"
            local_note = (
                "local extracted package was inspected; matched files are only search candidates, "
                "not accepted closure evidence"
            )
        else:
            local_status = "missing_cache"
            local_note = (
                "fetch and extract the arXiv source package before interpreting local "
                "inspection results"
            )
        package_local_inspection_rows.append(
            {
                "package_rank": int(row["package_rank"]),
                "candidate_id": row["candidate_id"],
                "study": row["study"],
                "required_artifact": row["required_artifact"],
                "expected_extract_dir": row["expected_extract_dir"],
                "artifact_search_pattern": pattern_text,
                "local_inspection_status": local_status,
                "matched_file_count": int(len(matched_files)),
                "matched_files": ";".join(matched_files),
                "required_columns": row["required_columns"],
                "closure_boundary": row["closure_boundary"],
                "local_cache_note": local_note,
            }
        )
    package_local_inspection = pd.DataFrame(
        package_local_inspection_rows,
        columns=[
            "package_rank",
            "candidate_id",
    ...
    package_local_inspection.to_csv(
        output_dir
        / "public_g11_closure_evidence_arxiv_source_package_local_inspection.csv",
        index=False,
    )
    legacy_cache_dir_by_candidate = {
        "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING": (
            "outputs/tmp/kokorowski_source/extracted"
        ),
        "MIR_2007_WEAK_VALUE_MOMENTUM_TRANSFER": (
            "outputs/tmp/second_no_refit_sources/mir/extracted"
        ),
        "EIBENBERGER_2014_RECOIL_ABSORPTION": (
            "outputs/tmp/second_no_refit_sources/eibenberger"
        ),
        "HORNBERGER_2003_COLLISIONAL_DECOHERENCE": (
            "outputs/tmp/third_hunt_sources/hornberger/extracted"
        ),
        "HOCHRAINER_2017_INDUCED_COHERENCE_MOMENTUM_CORRELATION": (
            "outputs/tmp/second_no_refit_sources/hochrainer/extracted"
        ),
        "CORMANN_2016_MODULAR_VALUE": "outputs/tmp/third_hunt_sources/cormann",
    }
    package_cache_alias_rows = []
    for _, row in package_retrieval_ledger.iterrows():
        candidate_id = str(row["candidate_id"])
        expected_extract_dir = str(row["expected_extract_dir"])
        legacy_cache_dir = legacy_cache_dir_by_candidate.get(
            candidate_id,
            "not available",
        )
        if legacy_cache_dir == "not available":
            ...
            alias_command = (
                f"mkdir -p {expected_extract_dir} && "
                f"cp -R {legacy_cache_dir}/. {expected_extract_dir}/"
            )
        package_cache_alias_rows.append(
            {
                "package_rank": int(row["package_rank"]),
                "candidate_id": candidate_id,
                "study": row["study"],
                "expected_extract_dir": expected_extract_dir,
                "known_legacy_cache_dir": legacy_cache_dir,
                "cache_alias_status": "not_checked",
    ...
    package_cache_aliases = pd.DataFrame(
        package_cache_alias_rows,
        columns=[
            "package_rank",
            "candidate_id",
    ...
    package_cache_aliases.to_csv(
        output_dir
        / "public_g11_closure_evidence_arxiv_source_package_cache_aliases.csv",
        index=False,
    )
    package_cache_probe_rows = []
    for _, row in package_cache_aliases.iterrows():
        legacy_cache_dir = str(row["known_legacy_cache_dir"])
        has_known_cache_dir = legacy_cache_dir != "not available"
        if has_known_cache_dir:
            probe_command = (
                f"test -d {legacy_cache_dir} && "
                f"find {legacy_cache_dir} -type f | sort | wc -l"
            )
            post_probe_action = (
                "if file count meets threshold, run alias_command then rerun "
                "local inspection"
            )
        else:
            probe_command = (
            ...
            post_probe_action = (
                "fetch and extract the arXiv package before local inspection"
            )
        package_cache_probe_rows.append(
            {
                "package_rank": int(row["package_rank"]),
                "candidate_id": row["candidate_id"],
                "study": row["study"],
                "known_legacy_cache_dir": legacy_cache_dir,
                "cache_probe_status": "not_run",
                "expected_min_file_count": 1 if has_known_cache_dir else 0,
                "probe_command": probe_command,
                "post_probe_action": post_probe_action,
                "overclaim_boundary": row["overclaim_boundary"],
            }
        )
    package_cache_probe_plan = pd.DataFrame(
        package_cache_probe_rows,
        columns=[
            "package_rank",
            "candidate_id",
    ...
    package_cache_probe_plan.to_csv(
        output_dir
    ...
    package_acceptance_manifest_status = (
        ...
        and set(package_acceptance_manifest["package_acceptance_status"].astype(str))
        == {"not_checked"}
        else "mixed_or_empty"
    )
    package_retrieval_status = (
        "not_fetched"
        if not package_retrieval_ledger.empty
        and set(package_retrieval_ledger["retrieval_status"].astype(str))
        == {"not_fetched"}
        else "mixed_or_empty"
    )
    package_inspection_status = (
        "pending_fetch"
        if not package_inspection_checklist.empty
        and set(package_inspection_checklist["inspection_status"].astype(str))
        == {"pending_fetch"}
        else "mixed_or_empty"
    )
    package_local_inspection_status = (
        str(package_local_inspection["local_inspection_status"].iloc[0])
        if not package_local_inspection.empty
        and package_local_inspection["local_inspection_status"].astype(str).nunique()
        == 1
        else "mixed_or_empty"
    )
    package_cache_alias_status = (
        "not_checked"
        if not package_cache_aliases.empty
        and set(package_cache_aliases["cache_alias_status"].astype(str))
        == {"not_checked"}
        else "mixed_or_empty"
    )
    package_cache_probe_plan_status = (
        "not_run"
        if not package_cache_probe_plan.empty
        and set(package_cache_probe_plan["cache_probe_status"].astype(str))
        == {"not_run"}
        else "mixed_or_empty"
    )
    ...
    top_package_acceptance_candidate = (
        str(package_acceptance_manifest.iloc[0]["candidate_id"])
        if not package_acceptance_manifest.empty
        else "not available"
    )
    top_package_required_artifact = (
        str(package_acceptance_manifest.iloc[0]["required_artifact"])
        if not package_acceptance_manifest.empty
        else "not available"
    )
    top_package_retrieval_candidate = (
        str(package_retrieval_ledger.iloc[0]["candidate_id"])
        if not package_retrieval_ledger.empty
        else "not available"
    )
    top_package_expected_archive = (
        str(package_retrieval_ledger.iloc[0]["expected_archive_path"])
        if not package_retrieval_ledger.empty
        else "not available"
    )
    top_package_inspection_candidate = (
        str(package_inspection_checklist.iloc[0]["candidate_id"])
        if not package_inspection_checklist.empty
        else "not available"
    )
    top_package_inspection_pattern = (
        str(package_inspection_checklist.iloc[0]["artifact_search_pattern"])
        if not package_inspection_checklist.empty
        else "not available"
    )
    top_package_local_inspection_candidate = (
        str(package_local_inspection.iloc[0]["candidate_id"])
        if not package_local_inspection.empty
        else "not available"
    )
    top_package_local_inspection_match_count = (
        int(package_local_inspection.iloc[0]["matched_file_count"])
        if not package_local_inspection.empty
        else 0
    )
    top_package_cache_alias_candidate = (
        str(package_cache_aliases.iloc[0]["candidate_id"])
        if not package_cache_aliases.empty
        else "not available"
    )
    top_package_cache_alias_legacy_dir = (
        str(package_cache_aliases.iloc[0]["known_legacy_cache_dir"])
        if not package_cache_aliases.empty
        else "not available"
    )
    top_package_cache_probe_candidate = (
        str(package_cache_probe_plan.iloc[0]["candidate_id"])
        if not package_cache_probe_plan.empty
        else "not available"
    )
    top_package_cache_probe_expected_min_files = (
        int(package_cache_probe_plan.iloc[0]["expected_min_file_count"])
        if not package_cache_probe_plan.empty
        else 0
    )
        ...
        [
            {
                ...
                "closure_evidence_arxiv_package_acceptance_manifest_rows": int(
                    len(package_acceptance_manifest)
                ),
                "closure_evidence_arxiv_package_acceptance_manifest_status": package_acceptance_manifest_status,
                "closure_evidence_top_arxiv_package_acceptance_candidate_id": top_package_acceptance_candidate,
                "closure_evidence_top_arxiv_package_required_artifact": top_package_required_artifact,
                "closure_evidence_arxiv_package_retrieval_ledger_rows": int(
                    len(package_retrieval_ledger)
                ),
                "closure_evidence_arxiv_package_retrieval_status": package_retrieval_status,
                "closure_evidence_top_arxiv_package_retrieval_candidate_id": top_package_retrieval_candidate,
                "closure_evidence_top_arxiv_package_expected_archive": top_package_expected_archive,
                "closure_evidence_arxiv_package_inspection_checklist_rows": int(
                    len(package_inspection_checklist)
                ),
                "closure_evidence_arxiv_package_inspection_status": package_inspection_status,
                "closure_evidence_top_arxiv_package_inspection_candidate_id": top_package_inspection_candidate,
                "closure_evidence_top_arxiv_package_inspection_pattern": top_package_inspection_pattern,
                "closure_evidence_arxiv_package_local_inspection_rows": int(
                    len(package_local_inspection)
                ),
                "closure_evidence_arxiv_package_local_inspection_status": package_local_inspection_status,
                "closure_evidence_top_arxiv_package_local_inspection_candidate_id": top_package_local_inspection_candidate,
                "closure_evidence_top_arxiv_package_local_inspection_match_count": top_package_local_inspection_match_count,
                "closure_evidence_arxiv_package_cache_alias_rows": int(
                    len(package_cache_aliases)
                ),
                "closure_evidence_arxiv_package_cache_alias_status": package_cache_alias_status,
                "closure_evidence_top_arxiv_package_cache_alias_candidate_id": top_package_cache_alias_candidate,
                "closure_evidence_top_arxiv_package_cache_alias_legacy_dir": top_package_cache_alias_legacy_dir,
                "closure_evidence_arxiv_package_cache_probe_plan_rows": int(
                    len(package_cache_probe_plan)
                ),
                "closure_evidence_arxiv_package_cache_probe_plan_status": package_cache_probe_plan_status,
                "closure_evidence_top_arxiv_package_cache_probe_candidate_id": top_package_cache_probe_candidate,
                "closure_evidence_top_arxiv_package_cache_probe_expected_min_files": top_package_cache_probe_expected_min_files,
...
- Closure evidence arXiv package acceptance manifest rows: {int(len(package_acceptance_manifest))}
- Closure evidence arXiv package acceptance manifest status: {package_acceptance_manifest_status}
- Closure evidence top arXiv package required artifact: {top_package_required_artifact}
- Closure evidence arXiv package retrieval ledger rows: {int(len(package_retrieval_ledger))}
- Closure evidence arXiv package retrieval status: {package_retrieval_status}
- Closure evidence top arXiv package expected archive: {top_package_expected_archive}
- Closure evidence arXiv package inspection checklist rows: {int(len(package_inspection_checklist))}
- Closure evidence arXiv package inspection status: {package_inspection_status}
- Closure evidence top arXiv package inspection pattern: {top_package_inspection_pattern}
- Closure evidence arXiv package local inspection rows: {int(len(package_local_inspection))}
- Closure evidence arXiv package local inspection status: {package_local_inspection_status}
- Closure evidence top arXiv package local inspection matches: {top_package_local_inspection_match_count}
- Closure evidence arXiv package cache alias rows: {int(len(package_cache_aliases))}
- Closure evidence arXiv package cache alias status: {package_cache_alias_status}
- Closure evidence top arXiv package cache alias legacy dir: {top_package_cache_alias_legacy_dir}
- Closure evidence arXiv package cache probe plan rows: {int(len(package_cache_probe_plan))}
- Closure evidence arXiv package cache probe plan status: {package_cache_probe_plan_status}
- Closure evidence top arXiv package cache probe expected min files: {top_package_cache_probe_expected_min_files}
        ...
        [
            {
                ...
                "current_state": (
                    (
                        ...
                        f"arXiv package acceptance manifest={g11_closure_evidence_arxiv_package_acceptance_manifest_rows}; "
                        f"arXiv package acceptance status={g11_closure_evidence_arxiv_package_acceptance_manifest_status}; "
                        f"top arXiv package acceptance candidate={g11_closure_evidence_top_arxiv_package_acceptance_candidate_id}; "
                        f"top arXiv package required artifact={g11_closure_evidence_top_arxiv_package_required_artifact}; "
                        f"arXiv package retrieval ledger={g11_closure_evidence_arxiv_package_retrieval_ledger_rows}; "
                        f"arXiv package retrieval status={g11_closure_evidence_arxiv_package_retrieval_status}; "
                        f"top arXiv package retrieval candidate={g11_closure_evidence_top_arxiv_package_retrieval_candidate_id}; "
                        f"top arXiv package expected archive={g11_closure_evidence_top_arxiv_package_expected_archive}; "
                        f"arXiv package inspection checklist={g11_closure_evidence_arxiv_package_inspection_checklist_rows}; "
                        f"arXiv package inspection status={g11_closure_evidence_arxiv_package_inspection_status}; "
                        f"top arXiv package inspection candidate={g11_closure_evidence_top_arxiv_package_inspection_candidate_id}; "
                        f"top arXiv package inspection pattern={g11_closure_evidence_top_arxiv_package_inspection_pattern}; "
                        f"arXiv package local inspection rows={g11_closure_evidence_arxiv_package_local_inspection_rows}; "
                        f"arXiv package local inspection status={g11_closure_evidence_arxiv_package_local_inspection_status}; "
                        f"top arXiv package local inspection candidate={g11_closure_evidence_top_arxiv_package_local_inspection_candidate_id}; "
                        f"top arXiv package local inspection matches={g11_closure_evidence_top_arxiv_package_local_inspection_match_count}; "
                        f"arXiv package cache aliases={g11_closure_evidence_arxiv_package_cache_alias_rows}; "
                        f"arXiv package cache alias status={g11_closure_evidence_arxiv_package_cache_alias_status}; "
                        f"top arXiv package cache alias candidate={g11_closure_evidence_top_arxiv_package_cache_alias_candidate_id}; "
                        f"top arXiv package cache alias legacy dir={g11_closure_evidence_top_arxiv_package_cache_alias_legacy_dir}; "
                        f"arXiv package cache probe plan={g11_closure_evidence_arxiv_package_cache_probe_plan_rows}; "
                        f"arXiv package cache probe status={g11_closure_evidence_arxiv_package_cache_probe_plan_status}; "
                        f"top arXiv package cache probe candidate={g11_closure_evidence_top_arxiv_package_cache_probe_candidate_id}; "
                        f"top arXiv package cache probe expected min files={g11_closure_evidence_top_arxiv_package_cache_probe_expected_min_files}; "
