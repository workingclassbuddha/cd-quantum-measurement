...
- **Chapman et al. 1995** (`chapman_1995_raw_phase_trace`): current G10 blocker; ask for numerical Fig. 2 raw phase/fringe-fit trace and wrap provenance before adding more model freedom
...
- **Chapman et al. 1995**: draft_ready_not_sent; issue: https://github.com/workingclassbuddha/cd-quantum-measurement/issues/8; G11 use: G10 phase-repair data; useful but cannot close G11 alone
...
chapman_1995_raw_phase_trace_request.md
```
