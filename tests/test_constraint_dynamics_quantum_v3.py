...
def test_current_goal_completion_audit_outputs_and_cli(tmp_path):
        ...
        [
            {
                ...
                "closure_evidence_blocked_class_count": 3,
                "closure_evidence_blocked_candidate_count": 14,
                ...
                "closure_evidence_non_arxiv_artifact_review_receipt_template_rows": 21,
                "closure_evidence_non_arxiv_artifact_review_receipt_template_status": "template_ready",
                "closure_evidence_top_non_arxiv_artifact_review_receipt_candidate_id": "YOON_2021_QUANTITATIVE_COMPLEMENTARITY",
                "closure_evidence_non_arxiv_artifact_review_receipt_verification_plan_rows": 21,
                "closure_evidence_non_arxiv_artifact_review_receipt_verification_plan_status": "receipt_pending",
                "closure_evidence_top_non_arxiv_artifact_review_receipt_verification_candidate_id": "YOON_2021_QUANTITATIVE_COMPLEMENTARITY",
                ...
                "closure_evidence_top_arxiv_source_package_url": "https://arxiv.org/e-print/quant-ph/0009044",
                "closure_evidence_arxiv_package_acceptance_manifest_rows": 21,
                ...
                "closure_evidence_arxiv_package_inspection_checklist_rows": 21,
                "closure_evidence_arxiv_package_inspection_status": "pending_fetch",
                "closure_evidence_top_arxiv_package_inspection_candidate_id": "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING",
                "closure_evidence_top_arxiv_package_inspection_pattern": "beam|deflection|broadening|calibration|kappa",
                "closure_evidence_arxiv_package_local_inspection_rows": 21,
                ...
                "closure_evidence_arxiv_package_extraction_target_rows": 21,
                "closure_evidence_arxiv_package_extraction_target_status": "planned",
                "closure_evidence_top_arxiv_package_extraction_target_candidate_id": "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING",
                "closure_evidence_top_arxiv_package_extraction_target_source_file_hint": "decoh.tex",
                "closure_evidence_arxiv_package_line_evidence_manifest_rows": 21,
                "closure_evidence_arxiv_package_line_evidence_manifest_status": "not_extracted",
                "closure_evidence_top_arxiv_package_line_evidence_candidate_id": "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING",
                "closure_evidence_top_arxiv_package_line_evidence_source_file_hint": "decoh.tex",
                "closure_evidence_arxiv_package_line_evidence_receipt_template_rows": 21,
                ...
                "closure_evidence_arxiv_package_line_evidence_receipt_acceptance_ledger_rows": 21,
                "closure_evidence_arxiv_package_line_evidence_receipt_acceptance_ledger_status": "awaiting_reviewed_receipt",
                "closure_evidence_arxiv_package_line_evidence_receipt_accepted_count": 0,
                "closure_evidence_arxiv_package_line_evidence_receipt_closure_credit_allowed": False,
                "closure_evidence_top_arxiv_package_line_evidence_receipt_acceptance_candidate_id": "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING",
                "closure_evidence_arxiv_package_line_evidence_receipt_candidate_rollup_rows": 7,
                "closure_evidence_arxiv_package_line_evidence_receipt_candidate_rollup_status": "awaiting_reviewed_receipts",
    ...
    assert int(summary["g11_closure_evidence_candidate_action_rows"].iloc[0]) == 14
    assert (
        int(summary["g11_closure_evidence_candidate_action_blocked_count"].iloc[0])
        == 14
    )
    ...
    assert int(summary["g11_closure_evidence_source_query_batch_rows"].iloc[0]) == 3
    assert summary["g11_closure_evidence_source_query_top_batch_class"].iloc[0] == (
    ...
    assert int(summary["g11_closure_evidence_source_route_checklist_rows"].iloc[0]) == 14
    assert summary["g11_closure_evidence_source_route_checklist_status"].iloc[0] == (
        "not_checked"
    )
    ...
    assert int(
        summary["g11_closure_evidence_arxiv_source_package_inventory_rows"].iloc[0]
    ) == 7
    assert summary[
        "g11_closure_evidence_arxiv_source_package_inventory_status"
    ].iloc[0] == "not_checked"
    assert summary[
        "g11_closure_evidence_top_arxiv_source_package_candidate_id"
    ].iloc[0] == "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING"
    assert int(
        summary["g11_closure_evidence_arxiv_package_acceptance_manifest_rows"].iloc[0]
    ) == 21
    assert summary[
        "g11_closure_evidence_arxiv_package_acceptance_manifest_status"
    ].iloc[0] == "not_checked"
    assert summary[
    ...
    assert int(
        summary["g11_closure_evidence_arxiv_package_inspection_checklist_rows"].iloc[0]
    ) == 21
    assert summary[
        "g11_closure_evidence_arxiv_package_inspection_status"
    ].iloc[0] == "pending_fetch"
    assert summary[
        "g11_closure_evidence_top_arxiv_package_inspection_pattern"
    ].iloc[0] == "beam|deflection|broadening|calibration|kappa"
    assert int(
        summary["g11_closure_evidence_arxiv_package_local_inspection_rows"].iloc[0]
    ) == 21
    assert summary[
        "g11_closure_evidence_arxiv_package_local_inspection_status"
    ].iloc[0] == "missing_cache"
    assert summary[
        "g11_closure_evidence_top_arxiv_package_local_inspection_candidate_id"
    ].iloc[0] == "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING"
    assert int(
        summary[
    ...
    assert int(
        summary["g11_closure_evidence_arxiv_package_extraction_target_rows"].iloc[0]
    ) == 21
    assert summary[
        "g11_closure_evidence_arxiv_package_extraction_target_status"
    ].iloc[0] == "planned"
    assert summary[
        "g11_closure_evidence_top_arxiv_package_extraction_target_candidate_id"
    ].iloc[0] == "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING"
    assert summary[
        "g11_closure_evidence_top_arxiv_package_extraction_target_source_file_hint"
    ].iloc[0] == "decoh.tex"
    assert int(
        summary[
            "g11_closure_evidence_arxiv_package_line_evidence_manifest_rows"
        ].iloc[0]
    ) == 21
    assert summary[
        "g11_closure_evidence_arxiv_package_line_evidence_manifest_status"
    ].iloc[0] == "not_extracted"
    assert summary[
        "g11_closure_evidence_top_arxiv_package_line_evidence_candidate_id"
    ].iloc[0] == "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING"
    assert summary[
        "g11_closure_evidence_top_arxiv_package_line_evidence_source_file_hint"
    ].iloc[0] == "decoh.tex"
    assert (
    ...
    assert (
        summary["g11_closure_evidence_arxiv_package_local_inspection_status"].iloc[0]
        == "missing_cache"
    )
    assert (
        summary[
    ...
    assert (
        summary["g11_closure_evidence_arxiv_package_extraction_target_status"].iloc[0]
        == "planned"
    )
    assert (
        summary[
    ...
    assert (
        int(
            summary[
                "g11_closure_evidence_arxiv_package_line_evidence_receipt_template_rows"
            ].iloc[0]
        )
        == 21
    )
    assert (
        summary[
            "g11_closure_evidence_arxiv_package_line_evidence_receipt_template_status"
        ].iloc[0]
        == "template_ready"
    )
    assert (
        summary[
            "g11_closure_evidence_top_arxiv_package_line_evidence_receipt_candidate_id"
        ].iloc[0]
        == "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING"
    )
    assert (
        summary[
            "g11_closure_evidence_top_arxiv_package_line_evidence_receipt_required_columns"
        ].iloc[0]
        == (
            "candidate_id;required_artifact;source_file_hint;source_sha256;"
            "query_pattern;matched_line_count;matched_line_numbers;"
            "short_excerpt_hashes;acceptance_decision;closure_eligible;"
            "reviewer_note"
        )
    )
    assert (
    ...
    assert (
        int(
            summary[
                "g11_closure_evidence_arxiv_package_line_evidence_receipt_acceptance_ledger_rows"
            ].iloc[0]
        )
        == 21
    )
    assert (
        summary[
            "g11_closure_evidence_arxiv_package_line_evidence_receipt_acceptance_ledger_status"
        ].iloc[0]
    ...
    assert (
        int(
            summary[
                "g11_closure_evidence_arxiv_package_line_evidence_receipt_accepted_count"
            ].iloc[0]
        )
        == 0
    )
    assert (
        bool(
            summary[
                "g11_closure_evidence_arxiv_package_line_evidence_receipt_closure_credit_allowed"
            ].iloc[0]
        )
        is False
    )
    assert (
        int(
            summary[
                "g11_closure_evidence_arxiv_package_line_evidence_receipt_candidate_rollup_rows"
            ].iloc[0]
        )
        == 7
    )
    assert (
        summary[
            "g11_closure_evidence_arxiv_package_line_evidence_receipt_candidate_rollup_status"
        ].iloc[0]
        == "awaiting_reviewed_receipts"
    )
    assert (
        int(
            summary[
                "g11_closure_evidence_arxiv_package_line_evidence_receipt_closure_ready_candidate_count"
            ].iloc[0]
        )
        == 0
    )
    assert (
        summary[
            "g11_closure_evidence_top_arxiv_package_line_evidence_receipt_rollup_candidate_id"
        ].iloc[0]
        == "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING"
    )
    assert (
        int(
            summary[
                "g11_closure_evidence_top_arxiv_package_line_evidence_receipt_rollup_pending_count"
            ].iloc[0]
        )
        == 3
    )
    ...
    assert "closure_blocked_classes=3" in g11_row["note"]
    assert "closure_blocked_candidates=14" in g11_row["note"]
    ...
    assert "closure_arxiv_source_package_inventory=7" in g11_row["note"]
    ...
    assert "closure_arxiv_package_inspection_checklist=21" in g11_row["note"]
    assert "closure_arxiv_package_inspection_status=pending_fetch" in g11_row["note"]
    assert (
        "closure_evidence_classes=independent_record_distribution;paired_visibility_curve;raw_calibration_tables"
        in g11_row["note"]
    )
    ...
    assert "closure_arxiv_package_extraction_targets=21" in second_row["note"]
    assert "closure_arxiv_package_extraction_status=planned" in second_row["note"]
    assert "closure_arxiv_package_line_evidence_manifest=21" in second_row["note"]
    assert "closure_arxiv_package_line_evidence_status=not_extracted" in second_row[
        "note"
    ]
    assert "closure_arxiv_package_line_evidence_receipt_templates=21" in second_row[
        "note"
    ]
    assert (
        "closure_arxiv_package_line_evidence_receipt_template_status=template_ready"
        in second_row["note"]
    )
    assert (
    ...
    assert "closure_arxiv_package_line_evidence_receipt_acceptance_ledger=21" in (
        second_row["note"]
    )
    assert "closure_arxiv_package_line_evidence_receipt_acceptance_status=awaiting_reviewed_receipt" in (
        second_row["note"]
    )
    assert "closure_arxiv_package_line_evidence_receipt_accepted=0" in (
        second_row["note"]
    )
    assert "closure_arxiv_package_line_evidence_receipt_closure_credit_allowed=False" in (
        second_row["note"]
    )
    assert "closure_arxiv_package_line_evidence_receipt_candidate_rollup=7" in (
        second_row["note"]
    )
    assert "closure_arxiv_package_line_evidence_receipt_candidate_rollup_status=awaiting_reviewed_receipts" in (
        second_row["note"]
    )
    assert "closure_arxiv_package_line_evidence_receipt_closure_ready_candidates=0" in (
        second_row["note"]
    )
    assert (
        "closure_top_arxiv_package_line_evidence_receipt_rollup_candidate="
        "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING"
        in second_row["note"]
    )
...
def test_public_g11_exhaustion_audit_outputs_and_cli(tmp_path):
    ...
    }.issubset(class_preflight.columns)
    class_counts = class_preflight.set_index("evidence_class")
    assert int(class_counts.loc["raw_calibration_tables", "candidate_count"]) == 1
    assert int(class_counts.loc["paired_visibility_curve", "candidate_count"]) == 4
    assert int(class_counts.loc["independent_record_distribution", "candidate_count"]) == 9
    assert int(class_counts.loc["raw_calibration_tables", "missing_artifact_row_count"]) == 3
    assert int(class_counts.loc["paired_visibility_curve", "missing_artifact_row_count"]) == 12
    assert int(class_counts.loc["independent_record_distribution", "missing_artifact_row_count"]) == 27
    assert bool(class_counts.loc["raw_calibration_tables", "class_preflight_passed"]) is False
    assert "beam_deflection_broadening_calibration.csv" in class_counts.loc[
        "raw_calibration_tables",
        "representative_missing_artifacts",
    ]
    assert int(summary["closure_evidence_blocked_class_count"].iloc[0]) == 3
    assert int(summary["closure_evidence_blocked_candidate_count"].iloc[0]) == 14
    ...
    assert {
        ...
        "first_valid_action",
        "overclaim_boundary",
    }.issubset(candidate_actions.columns)
    assert len(candidate_actions) == 14
    assert bool(candidate_actions["candidate_preflight_passed"].any()) is False
    kokorowski_action = candidate_actions[
        candidate_actions["candidate_id"] == "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING"
    ].iloc[0]
    assert kokorowski_action["evidence_class"] == "raw_calibration_tables"
    assert int(kokorowski_action["priority_rank"]) == 1
    assert int(kokorowski_action["missing_artifact_count"]) == 3
    assert int(kokorowski_action["missing_artifact_rows"]) == 3
    assert (
        kokorowski_action["first_missing_artifact"]
        == "beam_deflection_broadening_calibration.csv"
    )
    assert "beam-deflection/broadening calibration tables" in kokorowski_action[
        "first_valid_action"
    ]
    mir_action = candidate_actions[
        candidate_actions["candidate_id"] == "MIR_2007_WEAK_VALUE_MOMENTUM_TRANSFER"
    ].iloc[0]
    assert mir_action["evidence_class"] == "paired_visibility_curve"
    assert int(mir_action["missing_artifact_count"]) == 3
    assert mir_action["first_missing_artifact"] == "record_distribution.csv"
    assert "paired visibility or contrast sweep" in mir_action["first_valid_action"]
    assert int(summary["closure_evidence_candidate_action_rows"].iloc[0]) == 14
    assert int(summary["closure_evidence_candidate_action_blocked_count"].iloc[0]) == 14
    ...
    source_query_batches = pd.read_csv(
    ...
    assert {
        ...
        "acceptance_focus",
        "overclaim_boundary",
    }.issubset(source_query_batches.columns)
    assert len(source_query_batches) == 3
    top_batch = source_query_batches.iloc[0]
    assert top_batch["evidence_class"] == "raw_calibration_tables"
    assert int(top_batch["query_rows"]) == 3
    assert int(top_batch["candidate_count"]) == 1
    assert top_batch["first_candidate_id"] == (
        "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING"
    )
    assert top_batch["first_source_query"] == (
        "Kokorowski 2001 multiphoton beam deflection broadening calibration "
        "kappa uncertainty"
    )
    assert set(source_query_batches["batch_status"]) == {"not_searched"}
    paired_batch = source_query_batches[
        source_query_batches["evidence_class"] == "paired_visibility_curve"
    ].iloc[0]
    assert int(paired_batch["query_rows"]) == 12
    independent_batch = source_query_batches[
        source_query_batches["evidence_class"] == "independent_record_distribution"
    ].iloc[0]
    assert int(independent_batch["query_rows"]) == 27
    assert int(summary["closure_evidence_source_query_batch_rows"].iloc[0]) == 3
    assert summary["closure_evidence_source_query_top_batch_class"].iloc[0] == (
        "raw_calibration_tables"
    )
    ...
    assert {
        ...
        "overclaim_boundary",
    }.issubset(route_checklist.columns)
    assert len(route_checklist) == 14
    assert set(route_checklist["route_check_status"]) == {"not_checked"}
    top_route_check = route_checklist.iloc[0]
    assert top_route_check["candidate_id"] == (
        "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING"
    )
    assert top_route_check["primary_source_url"] == (
        "https://arxiv.org/abs/quant-ph/0009044"
    )
    assert int(top_route_check["route_rows"]) == 3
    assert "beam_deflection_broadening_calibration.csv" in top_route_check[
        "artifact_focuses"
    ]
    assert "kappa_uncertainty_notes.md" in top_route_check["artifact_focuses"]
    mir_route_check = route_checklist[
        route_checklist["candidate_id"] == "MIR_2007_WEAK_VALUE_MOMENTUM_TRANSFER"
    ].iloc[0]
    assert int(mir_route_check["route_rows"]) == 3
    assert mir_route_check["primary_source_url"] == "https://arxiv.org/abs/0706.3966"
    assert int(summary["closure_evidence_source_route_checklist_rows"].iloc[0]) == 14
    assert summary["closure_evidence_source_route_checklist_status"].iloc[0] == (
        "not_checked"
    )
    ...
    non_arxiv_review_receipts = pd.read_csv(
        output_dir
    ...
    assert {
        ...
        "receipt_fill_command",
        "review_gate",
        "closure_boundary",
    }.issubset(non_arxiv_review_receipts.columns)
    assert len(non_arxiv_review_receipts) == 21
    assert set(non_arxiv_review_receipts["receipt_template_status"]) == {
        "template_ready"
    }
    top_non_arxiv_receipt = non_arxiv_review_receipts.iloc[0]
    assert top_non_arxiv_receipt["candidate_id"] == (
        "YOON_2021_QUANTITATIVE_COMPLEMENTARITY"
    )
    assert top_non_arxiv_receipt["required_artifact"] == "independence_provenance.md"
    assert top_non_arxiv_receipt["required_receipt_columns"] == (
        "candidate_id;required_artifact;source_url;source_page_sha256;"
        "reviewed_artifact_status;matched_evidence_locator;acceptance_decision;"
        "closure_eligible;reviewer_note"
    )
    assert "printf" in top_non_arxiv_receipt["receipt_fill_command"]
    assert "PENDING_SOURCE_PAGE_SHA256" in top_non_arxiv_receipt[
        "receipt_fill_command"
    ]
    assert "closure_eligible" in top_non_arxiv_receipt["review_gate"]
    assert int(
        summary[
            "closure_evidence_non_arxiv_artifact_review_receipt_template_rows"
        ].iloc[0]
    ) == 21
    assert summary[
        "closure_evidence_non_arxiv_artifact_review_receipt_template_status"
    ].iloc[0] == "template_ready"
    assert summary[
        "closure_evidence_top_non_arxiv_artifact_review_receipt_candidate_id"
    ].iloc[0] == "YOON_2021_QUANTITATIVE_COMPLEMENTARITY"
    non_arxiv_review_receipt_verification = pd.read_csv(
        output_dir
    ...
    assert {
        ...
        "closure_credit_allowed",
        "overclaim_boundary",
    }.issubset(non_arxiv_review_receipt_verification.columns)
    assert len(non_arxiv_review_receipt_verification) == 21
    assert set(
        non_arxiv_review_receipt_verification["receipt_verification_status"]
    ) == {"receipt_pending"}
    assert bool(
        non_arxiv_review_receipt_verification["closure_credit_allowed"].any()
    ) is False
    top_non_arxiv_verification = non_arxiv_review_receipt_verification.iloc[0]
    assert top_non_arxiv_verification["candidate_id"] == (
        "YOON_2021_QUANTITATIVE_COMPLEMENTARITY"
    )
    assert top_non_arxiv_verification["required_artifact"] == (
        "independence_provenance.md"
    )
    assert "pd.read_csv" in top_non_arxiv_verification["verification_command"]
    assert "PENDING_SOURCE_PAGE_SHA256" in top_non_arxiv_verification[
        "verification_command"
    ]
    assert "closure_eligible=true" in top_non_arxiv_verification["acceptance_gate"]
    assert int(
        summary[
    ...
    assert {
        ...
        "acceptance_gate",
        "overclaim_boundary",
    }.issubset(source_package_inventory.columns)
    assert len(source_package_inventory) == 7
    assert set(source_package_inventory["source_package_status"]) == {"not_checked"}
    top_package = source_package_inventory.iloc[0]
    assert top_package["candidate_id"] == "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING"
    assert top_package["source_eprint_url"] == (
        "https://arxiv.org/e-print/quant-ph/0009044"
    )
    assert "TeX/EPS/source package files" in top_package[
        "expected_source_package_focus"
    ]
    assert "raw beam-deflection/broadening calibration tables" in top_package[
        "acceptance_gate"
    ]
    mir_package = source_package_inventory[
        source_package_inventory["candidate_id"]
        == "MIR_2007_WEAK_VALUE_MOMENTUM_TRANSFER"
    ].iloc[0]
    assert mir_package["source_eprint_url"] == "https://arxiv.org/e-print/0706.3966"
    assert "paired visibility" in mir_package["acceptance_gate"]
    source_package_acceptance = pd.read_csv(
        output_dir
    ...
    assert {
        ...
        "acceptance_gate",
        "closure_boundary",
    }.issubset(source_package_acceptance.columns)
    assert len(source_package_acceptance) == 21
    assert set(source_package_acceptance["package_acceptance_status"]) == {
        "not_checked"
    }
    top_acceptance = source_package_acceptance.iloc[0]
    assert top_acceptance["candidate_id"] == (
        "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING"
    )
    assert top_acceptance["required_artifact"] == (
        "beam_deflection_broadening_calibration.csv"
    )
    assert "calibration_observable" in top_acceptance["required_columns"]
    assert "Does the extracted arXiv source package contain" in top_acceptance[
        "triage_question"
    ]
    mir_acceptance = source_package_acceptance[
        (
            source_package_acceptance["candidate_id"]
            == "MIR_2007_WEAK_VALUE_MOMENTUM_TRANSFER"
        )
        & (
            source_package_acceptance["required_artifact"]
            == "visibility_or_contrast_sweep.csv"
        )
    ].iloc[0]
    ...
    source_package_inspection = pd.read_csv(
        output_dir
    ...
    assert {
        ...
        "required_columns",
        "closure_boundary",
    }.issubset(source_package_inspection.columns)
    assert len(source_package_inspection) == 21
    assert set(source_package_inspection["inspection_status"]) == {"pending_fetch"}
    top_inspection = source_package_inspection.iloc[0]
    assert top_inspection["candidate_id"] == (
        "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING"
    )
    assert top_inspection["required_artifact"] == (
        "beam_deflection_broadening_calibration.csv"
    )
    assert top_inspection["artifact_search_pattern"] == (
        "beam|deflection|broadening|calibration|kappa"
    )
    assert "grep -RIlE" in top_inspection["inspection_command"]
    assert "calibration_observable" in top_inspection["required_columns"]
    mir_inspection = source_package_inspection[
        (
            source_package_inspection["candidate_id"]
            == "MIR_2007_WEAK_VALUE_MOMENTUM_TRANSFER"
        )
        & (
            source_package_inspection["required_artifact"]
            == "visibility_or_contrast_sweep.csv"
        )
    ].iloc[0]
    assert mir_inspection["artifact_search_pattern"] == (
        "visibility|contrast|fringe|which-way|weak"
    )
    source_package_local_inspection = pd.read_csv(
        output_dir
    ...
    assert {
        ...
        "closure_boundary",
        "local_cache_note",
    }.issubset(source_package_local_inspection.columns)
    assert len(source_package_local_inspection) == 21
    assert set(source_package_local_inspection["local_inspection_status"]) == {
        "missing_cache"
    }
    top_local_inspection = source_package_local_inspection.iloc[0]
    assert top_local_inspection["candidate_id"] == (
        "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING"
    )
    assert top_local_inspection["required_artifact"] == (
        "beam_deflection_broadening_calibration.csv"
    )
    assert top_local_inspection["artifact_search_pattern"] == (
        "beam|deflection|broadening|calibration|kappa"
    )
    ...
    source_package_extraction_targets = pd.read_csv(
        output_dir
    ...
    assert {
        ...
        "acceptance_question",
        "overclaim_boundary",
    }.issubset(source_package_extraction_targets.columns)
    assert len(source_package_extraction_targets) == 21
    assert set(source_package_extraction_targets["extraction_status"]) == {"planned"}
    top_extraction = source_package_extraction_targets.iloc[0]
    assert top_extraction["candidate_id"] == (
        "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING"
    )
    assert top_extraction["required_artifact"] == (
        "beam_deflection_broadening_calibration.csv"
    )
    assert top_extraction["source_file_hint"] == "decoh.tex"
    assert "rg -n -i" in top_extraction["line_query_command"]
    assert "outputs/tmp/kokorowski_source/extracted/decoh.tex" in top_extraction[
        "line_query_command"
    ]
    assert "raw beam-deflection/broadening calibration" in top_extraction[
        "acceptance_question"
    ]
    mir_extraction = source_package_extraction_targets[
        (
            source_package_extraction_targets["candidate_id"]
            == "MIR_2007_WEAK_VALUE_MOMENTUM_TRANSFER"
        )
        & (
            source_package_extraction_targets["required_artifact"]
            == "record_distribution.csv"
        )
    ].iloc[0]
    assert mir_extraction["source_file_hint"] == "www-rev.tex"
    assert "outputs/tmp/second_no_refit_sources/mir/extracted/www-rev.tex" in (
        mir_extraction["line_query_command"]
    )
    source_package_line_evidence = pd.read_csv(
        output_dir
    ...
    assert {
        ...
        "acceptance_question",
        "overclaim_boundary",
    }.issubset(source_package_line_evidence.columns)
    assert len(source_package_line_evidence) == 21
    assert set(source_package_line_evidence["line_evidence_status"]) == {
        "not_extracted"
    }
    top_line_evidence = source_package_line_evidence.iloc[0]
    assert top_line_evidence["candidate_id"] == (
        "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING"
    )
    assert top_line_evidence["source_file_hint"] == "decoh.tex"
    assert "tee outputs/tmp" in top_line_evidence["line_evidence_command"]
    assert "beam|deflection|broadening|calibration|kappa" in top_line_evidence[
        "line_evidence_command"
    ]
    assert top_line_evidence["expected_evidence_kind"] == (
        "source line numbers and short source excerpts for the required artifact"
    )
    lahiri_line_evidence = source_package_line_evidence[
        source_package_line_evidence["candidate_id"]
        == "LAHIRI_2017_TWIN_PHOTON_CORRELATIONS"
    ].iloc[0]
    assert "echo 'no known ignored legacy cache" in lahiri_line_evidence[
        "line_evidence_command"
    ]
    source_package_line_receipts = pd.read_csv(
        output_dir
        / "public_g11_closure_evidence_arxiv_source_package_line_evidence_receipt_templates.csv"
    )
    assert {
        "package_rank",
        "candidate_id",
        ...
        "review_gate",
        "overclaim_boundary",
    }.issubset(source_package_line_receipts.columns)
    assert len(source_package_line_receipts) == 21
    assert set(source_package_line_receipts["receipt_template_status"]) == {
        "template_ready"
    }
    top_line_receipt = source_package_line_receipts.iloc[0]
    assert top_line_receipt["candidate_id"] == (
        "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING"
    )
    assert top_line_receipt["source_file_hint"] == "decoh.tex"
    assert top_line_receipt["required_receipt_columns"] == (
        "candidate_id;required_artifact;source_file_hint;source_sha256;query_pattern;"
        "matched_line_count;matched_line_numbers;short_excerpt_hashes;"
        "acceptance_decision;closure_eligible;reviewer_note"
    )
    assert (
        "outputs/tmp/arxiv_source_line_evidence_receipts/"
        "kokorowski-2001-multiphoton-scattering/"
        "beam-deflection-broadening-calibration.csv"
        in top_line_receipt["receipt_template_path"]
    )
    ...
    source_package_receipt_acceptance = pd.read_csv(
        output_dir
    ...
    assert {
        ...
        "next_valid_action",
        "closure_boundary",
    }.issubset(source_package_receipt_acceptance.columns)
    assert len(source_package_receipt_acceptance) == 21
    assert set(source_package_receipt_acceptance["acceptance_ledger_status"]) == {
        "awaiting_reviewed_receipt"
    }
    assert not source_package_receipt_acceptance["accepted_receipt_present"].map(
        bool
    ).any()
    assert not source_package_receipt_acceptance["closure_credit_allowed"].map(
        bool
    ).any()
    top_receipt_acceptance = source_package_receipt_acceptance.iloc[0]
    assert top_receipt_acceptance["candidate_id"] == (
        "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING"
    )
    assert (
        top_receipt_acceptance["receipt_template_path"]
        == top_line_receipt["receipt_template_path"]
    )
    assert top_receipt_acceptance["blocking_reason"] == (
        "no accepted non-placeholder source-line receipt has been reviewed"
    )
    assert "fill and pass" in top_receipt_acceptance["next_valid_action"]
    source_package_receipt_candidate_rollup = pd.read_csv(
        output_dir
    ...
    assert {
        ...
        "next_valid_action",
        "closure_boundary",
    }.issubset(source_package_receipt_candidate_rollup.columns)
    assert len(source_package_receipt_candidate_rollup) == 7
    assert set(source_package_receipt_candidate_rollup["candidate_receipt_status"]) == {
        "awaiting_reviewed_receipts"
    }
    assert not source_package_receipt_candidate_rollup["closure_credit_allowed"].map(
        bool
    ).any()
    top_receipt_candidate = source_package_receipt_candidate_rollup.iloc[0]
    assert top_receipt_candidate["candidate_id"] == (
        "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING"
    )
    assert int(top_receipt_candidate["required_receipt_count"]) == 3
    assert int(top_receipt_candidate["accepted_receipt_count"]) == 0
    assert int(top_receipt_candidate["pending_receipt_count"]) == 3
    assert top_receipt_candidate["missing_required_artifacts"] == (
    ...
    assert int(
        summary["closure_evidence_arxiv_source_package_inventory_rows"].iloc[0]
    ) == 7
    assert summary[
    ...
    ].iloc[0] == "https://arxiv.org/e-print/quant-ph/0009044"
    assert int(
        summary["closure_evidence_arxiv_package_acceptance_manifest_rows"].iloc[0]
    ) == 21
    assert summary[
    ...
    assert int(
        summary["closure_evidence_arxiv_package_inspection_checklist_rows"].iloc[0]
    ) == 21
    assert summary[
    ...
    assert int(
        summary["closure_evidence_arxiv_package_local_inspection_rows"].iloc[0]
    ) == 21
    assert summary[
    ...
    assert int(
        summary["closure_evidence_arxiv_package_extraction_target_rows"].iloc[0]
    ) == 21
    assert summary[
        "closure_evidence_arxiv_package_extraction_target_status"
    ].iloc[0] == "planned"
    assert summary[
        "closure_evidence_top_arxiv_package_extraction_target_candidate_id"
    ].iloc[0] == "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING"
    assert summary[
        "closure_evidence_top_arxiv_package_extraction_target_source_file_hint"
    ].iloc[0] == "decoh.tex"
    assert int(
        summary["closure_evidence_arxiv_package_line_evidence_manifest_rows"].iloc[0]
    ) == 21
    assert summary[
    ...
    assert int(
        summary[
            "closure_evidence_arxiv_package_line_evidence_receipt_template_rows"
        ].iloc[0]
    ) == 21
    assert summary[
        "closure_evidence_arxiv_package_line_evidence_receipt_template_status"
    ].iloc[0] == "template_ready"
    assert summary[
        "closure_evidence_top_arxiv_package_line_evidence_receipt_candidate_id"
    ].iloc[0] == "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING"
    assert summary[
        "closure_evidence_top_arxiv_package_line_evidence_receipt_required_columns"
    ].iloc[0] == (
        "candidate_id;required_artifact;source_file_hint;source_sha256;query_pattern;"
        "matched_line_count;matched_line_numbers;short_excerpt_hashes;"
        "acceptance_decision;closure_eligible;reviewer_note"
    ...
    ].iloc[0] == "awaiting_reviewed_receipt"
    assert int(
        summary[
    ...
    assert int(
        summary[
            "closure_evidence_arxiv_package_line_evidence_receipt_candidate_rollup_rows"
        ].iloc[0]
    ) == 7
    assert summary[
        "closure_evidence_arxiv_package_line_evidence_receipt_candidate_rollup_status"
    ].iloc[0] == "awaiting_reviewed_receipts"
    assert int(
        summary[
            "closure_evidence_arxiv_package_line_evidence_receipt_closure_ready_candidate_count"
        ].iloc[0]
    ) == 0
    assert summary[
        "closure_evidence_top_arxiv_package_line_evidence_receipt_rollup_candidate_id"
    ].iloc[0] == "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING"
    assert int(
        summary[
            "closure_evidence_top_arxiv_package_line_evidence_receipt_rollup_pending_count"
        ].iloc[0]
    ) == 3
...
def test_breakthrough_path_exhaustion_audit_outputs_and_cli(tmp_path):
    ...
    assert "closure blocked classes=3" in g11_row["current_state"]
    assert "closure blocked candidates=14" in g11_row["current_state"]
    assert "candidate actions=14" in g11_row["current_state"]
    assert "blocked candidate actions=14" in g11_row["current_state"]
    assert (
    ...
    assert "arXiv source package inventory=7" in g11_row["current_state"]
    ...
    assert "arXiv package inspection checklist=21" in g11_row["current_state"]
    assert "arXiv package inspection status=pending_fetch" in g11_row["current_state"]
    assert "arXiv package local inspection rows=21" in g11_row["current_state"]
    ...
    assert "arXiv package extraction targets=21" in g11_row["current_state"]
    assert "arXiv package extraction status=planned" in g11_row["current_state"]
    assert "arXiv package line evidence manifest=21" in g11_row["current_state"]
    assert "arXiv package line evidence status=not_extracted" in g11_row[
        "current_state"
    ]
    assert "arXiv package line evidence receipt templates=21" in g11_row[
        "current_state"
    ]
    assert "arXiv package line evidence receipt template status=template_ready" in (
    ...
    assert "arXiv package line evidence receipt acceptance ledger=21" in g11_row[
        "current_state"
    ]
    assert "arXiv package line evidence receipt acceptance status=awaiting_reviewed_receipt" in (
        g11_row["current_state"]
    )
    assert "arXiv package line evidence receipt accepted=0" in g11_row[
        "current_state"
    ]
    assert "arXiv package line evidence receipt closure credit allowed=False" in (
        g11_row["current_state"]
    )
    assert "arXiv package line evidence receipt candidate rollup=7" in g11_row[
        "current_state"
    ]
    assert "arXiv package line evidence receipt candidate rollup status=awaiting_reviewed_receipts" in (
        g11_row["current_state"]
    )
    assert "arXiv package line evidence receipt closure-ready candidates=0" in (
        g11_row["current_state"]
    )
    assert (
        "top arXiv package line evidence receipt rollup candidate="
        "KOKOROWSKI_2001_MULTIPHOTON_SCATTERING"
        in g11_row["current_state"]
    )
